...
public class ReportControllerTest {
	...
	public void testList() throws Exception {
		ModelAndView modelAndView = mockMvc.perform(get("/book_report/list"))
	...
	public void testGet() throws Exception {
		ModelAndView modelAndView = mockMvc.perform(get("/book_report/get").param("bno", "3"))
				.andReturn()
				.getModelAndView();
		Map<String, Object> model = modelAndView.getModel();
		log.info(model);
		log.info(modelAndView.getViewName());
		assertEquals("book_report/get",modelAndView.getViewName());
	...
	public void testRegister() throws Exception {
		ModelAndView modelAndView = mockMvc.perform(
				post("/book_report/register") //post요청 생성하고 수행
	...
	public void testModify() throws Exception {
		ModelAndView modelAndView = mockMvc.perform(
				post("/book_report/modify") //post요청 생성하고 수행
				.param("bno", "9")
